...
const NETWORK_CONFIGS: Record<NetworkEnvironment, NetworkConfig> = {
  ...
  devnet: {
    ...
    programId: process.env.BEAM_PROGRAM_ID || '6BjVpGR1pGJ41xDJF4mMuvC7vymFBZ8QXxoRKFqsuDDi',
    // USDC Devnet mint (custom test mint)
    usdcMint: process.env.USDC_MINT || 'CE32mZMypqjr93o5naYZBnrzHaWcPi1ATuyJwbyApb9N',
    // SECURITY: Mint authority is ONLY stored on backend verifier service
    // Mobile app requests USDC via verifier API, never mints directly
  ...
  'mainnet-beta': {
    ...
    usdcAuthoritySecret: process.env.USDC_MINT_AUTHORITY_SECRET,
...
export const Config = {
  ...
  tokens: {
    usdc: {
      ...
      decimals: 6,
      symbol: 'USDC',
      mintAuthoritySecret: networkConfig.usdcAuthoritySecret,
    },
  },
